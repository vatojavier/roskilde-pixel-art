...
export class MainCanvasComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.http.get(this.serverURL+'api/get_cookie', { withCredentials: true }).subscribe((data: any) => {
      ...
      this.http.get(this.serverURL+'api/get_max_pixels_per_user', { withCredentials: true }).subscribe((data: any) => {
        console.log('Max pixels:', data);
      });

      this.http.get(this.serverURL+'api/get_pixels_left', { withCredentials: true }).subscribe((data: any) => {
        console.log('Pixels left:', data);
      });

      this.http.get(this.serverURL+'api/get_max_cool_down_time', { withCredentials: true }).subscribe((data: any) => {
        console.log('max_cool_down_seconds:', data);
      });

      this.http.get(this.serverURL+'api/get_cool_down_time_left', { withCredentials: true }).subscribe((data: any) => {
  ...
  fetchCanvasData(): void {
    this.http.get<any[]>(this.serverURL+'api/get_canvas').subscribe(
      (data: any[]) => {
  ...
  sendPixelsForDeletion(selectedPixels: any[]) {
    ...
    this.http.post<any>(this.serverURL+'api/delete_pixels', data).subscribe(data => {
